...
class Person{	// private 멤버 필드, public getter/setter 가 있고, 기본생성자가 생략되어 있다(반드시 있어야함)
...
public class Ex06 {
	public static void main(String[] args) {
		...
		System.out.println("p1의 나이는 " + p1.getAge());	// ${p2.age }
		System.out.println();
		
		System.out.println("p2의 이름은 " + p2.get("name"));	// ${p2.name }
		System.out.println("p2의 나이는 " + p2.get("age"));		// ${p2.age } 똑같다
		System.out.println();	
	}
}

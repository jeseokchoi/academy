...
class MyComparator implements Comparator<Item>{		// Comparator - 함수형 메서드
...
public class Ex07 {
	public static void main(String[] args) {
		...
		list2.add(new Item("콘칩", 1900));
		list2.add(new Item("바밤바", 1200));
		list2.add(new Item("오예스", 2900));
...
//		System.out.println(list2);
		...
		MyComparator priceCmp = new MyComparator();		// Comparator
		list2.sort(priceCmp);
		...
		list2.sort(new Comparator<Item>() {
			...
			public int compare(Item o1, Item o2) {
				...
				// 문자열끼리 비교하여 그 차리를 int 타입으로 반환하는 함수 compareTo(s1, s2)

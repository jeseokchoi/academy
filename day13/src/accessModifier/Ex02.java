...
class Student2{
	...
	// 필드에 직접 접근할 수 없기 때문에, 필드의 값을 반환하는 함수(getter)를 만들어야 한다
...
public class Ex02 {
	public static void main(String[] args) {
		// 접근 제한자를 적용하지 않은 경우
		Student st1 = new Student("아이유", 99);
		System.out.println(st1.name + "의 점수는" + st1.score + "점 입니다");
		
		// 접근제한자를 적용하고, getter를 사용한 경우
		Student2 st2 = new Student2("최제석", 22);
//		System.out.println(st2.name + "의 점수는" + st2.score + "점 입니다");		// 데이터에 직접 접근하지 못하고 메서드를 통해서만 작업이 가능하다

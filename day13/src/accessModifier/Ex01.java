...
class Test1{		// 클래스(울타리) 필드
	private int n1 = 10;	// 생성자
	int n2 = 20;			// package는 기본값이므로, 접근제한자를 작성하지 않는다
	protected int n3 = 30;
	public int n4 = 40;
	
	public void showN1() {	// 메서드
		System.out.println(this.n1);		// private이라도 내부(울타리)에서는 접근 가능
	}
}

public class Ex01 {	// 또 다른 클래스(다른 울타리)

	public static void main(String[] args) {
		
		Test1 ob = new Test1();
//		System.out.println(ob.n1);	// The field Test1.n1 is not visible
		ob.showN1();				// 필드에 직접적으로 접근할 수는 없지만, 메서드를 통하여 출력을 할 수는 있다(메서드로 접근은 가능하다)
...
//		ob.n1 += 5;		// The field Test1.n1 is not visible 변경을 할 수 없다

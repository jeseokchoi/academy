...
//			System.out.print(arr[i] + " ");
	...
	public static void main(String[] args) {
		...
		showArray(arr);									// array(배열)의 요소 확인(정렬)하기
		...
		// 선택정렬(selection sort) 알고리즘			// 효율성이 심하게 낮다(이중 for문 이라서)비교할게 너무 많다
		...
		showArray(arr);									// 요소의 위치를 교환한 후 확인(정렬)하기

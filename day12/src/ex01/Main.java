...
public class Main {
	public static void main(String[] args) {
		...
		do {
			...
			case 1:	// 전체목록 (hd에게 결과를 요청하고, 결과를 result에 저장하여 출력
				result = hd.selectAll();
			...
			case 3:	// 검색 (검색어를 입력받아서, 검색어를 hd에게 전달하고, 결과를 받아서 화면에 출력)
				System.out.print("검색할 사람의 이름입력 : ");
				find = sc.nextLine();

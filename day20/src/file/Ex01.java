...
//		System.out.print("글자 하나 입력하세요 : ");
//		char ch = (char)System.in.read();
//		
//		System.out.println("입력한 글자는 " + ch);
		
		File f1 = new File("a.txt");					// 파일 이름만 문자열로 전달 (상대경로)
		File f2 = new File("C:\\20221110");				// 폴더 및 파일의 절대경로를 문자열로 전달	(절대경로 : 파일이름을 처음부터 끝까지 다 적어준다)
		...
		System.out.println("f2의 내부 파일 목록 : ");		// 대상이 폴더라면 내부에 뭐가있는지 확인할 수 있다
		String[] list = f2.list();

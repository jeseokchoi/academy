...
//		Animal 타입은 객체화 할 수 없습니다(추상클래스는 생성자를 통해 직접 객체를 생성할 수 없다)
//		Animal a1 = new Animal();
		
		Cat c1 = new Cat("흰둥이", 2);
		c1.bark();
		c1.grooming();
		
//		고양이는 동물이다(다형성)
		Animal a1 = new Cat("백구", 5);
...
//		a1.grooming();	// grooming()은 Animal에 정의되어 있지 않아서 호출 할 수 없다 
		...
		// 단, 오버라이딩 메서드는 슈퍼클래스에 정의되어있기 때문에 호출할 수 있고
